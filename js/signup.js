const loadModalSignup = () => {
    html = `
    <div class="modal fade" id="modal-signup" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    aria-hidden="true">
...
const SignUp = async () => {
    try {
        ...
        let result = await apiSignup(body)
        alert("Signed up")
